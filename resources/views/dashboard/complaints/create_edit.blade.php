                        ...
                        <div class="section-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4" id="nationalIdSection">
                                    ...
                                    <input type="text" class="form-control" name="ComplaintNationalID"
                                ...
                                <div class="col-md-6 mb-4" id="genderReadonlySection">
                                    ...
                                    <input type="text" class="form-control" name="ComplainerGender"
                                ...
                                <div class="col-md-6 mb-4" id="genderSelectSection" style="display:none;">
                                    ...
                                    <select class="form-select" name="ComplainerGenderSelect" id="ComplainerGenderSelect">
                                        ...
                                        <option value="ذكر"
                                            {{ old('ComplainerGender', $complaint->ComplainerGender ?? '') == 'ذكر' ? 'selected' : '' }}>
                                            ذكر</option>
                                        <option value="أنثى"
                                            {{ old('ComplainerGender', $complaint->ComplainerGender ?? '') == 'أنثى' ? 'selected' : '' }}>
                                            أنثى</option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('ComplainerName') is-invalid @enderror"
                                        name="ComplainerName"
                    ...
                    <div class="setup-content" id="step-2">
                        <div class="section-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label class="form-label">
                                        تصنيف البيان <span class="required-star"></span>
                                    </label>
                                    <select class="form-select @error('complainttype') is-invalid @enderror"
                                        name="complainttype" id="complainttype">
                                        <option value="">اختر تصنيف البيان </option>
                                        @foreach ($complainttype as $department)
                                            <option value="{{ $department->comtypeid }}"
                                                data-sector="{{ $department->request_fk }}"
                                                {{ old('complainttype', $complaint->ComplaintType ?? '') == $department->comtypeid ? 'selected' : '' }}>
                                                {{ $department->comtypename }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('complainttype')
                                ...
                                <div class="col-md-6 mb-4" id="officeGroup" style="display:none;">
                                    ...
                                    <select class="form-select @error('office') is-invalid @enderror" id="officeSelect"
                                        name="office">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-select select2-multi @error('comsource_ids') is-invalid @enderror"
                                        name="comsource_ids[]" id="comsourceSelect" multiple style="width:100%;">
                                        <option value="">اختر</option>
                                        @foreach ($comsources as $source)
                                            <option value="{{ $source->comsourcesid }}"
                                                @if (isset($complaint) && $complaint->sources->pluck('comsourcesid')->contains($source->comsourcesid)) selected @endif>
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea class="form-control @error('ComplaintText') is-invalid @enderror" name="ComplaintText" id="ComplaintText"
                                        rows="5" placeholder="أدخل تفاصيل البيان هنا...">{{ old('ComplaintText', $complaint->ComplaintText ?? '') }}</textarea>
                                    @error('ComplaintText')
                                        <div class="error-text">{{ $message }}</div>
                                    @enderror
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#requesttypeid").on("change", function() {
                ...
                let $dept = $('#complainttype');
                @if (isset($complaint->ComplaintType))
                    let currentVal = "{{ $complaint->ComplaintType }}";
                @else
                    let currentVal = "{{ old('complainttype') }}";
                @endif
                ...
                if (selectedSector && visibleCount === 0) {
                    $dept.append(
                        '<option class="no-dept" value="" disabled selected>لا يوجد تصنيف البيان </option>'
                    );
                    $dept.val('');
                } else {
