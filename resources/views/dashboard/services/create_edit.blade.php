...
<div class="classify-form" dir="rtl">
  ...
  <div class="main-card">
    ...
    <div class="form-header">
      ...
      <div>
        <h4>{{ isset($service) ? 'تعديل الخدمة' : 'إضافة خدمة جديدة' }}</h4>
        <p>يمكنك {{ isset($service) ? 'تحديث' : 'إضافة' }} بيانات الخدمة بسهولة.</p>
      </div>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-12 mb-4">
              <label class="form-label">
                اسم الخدمة <span class="required-star">*</span>
              </label>
              <input type="text"
            ...
            <div class="col-12 mb-4">
              ...
              <select class="form-select @error('validity') is-invalid @enderror" name="validity">
                <option value="1" {{ old('validity', $service->validity ?? 1) == 1 ? 'selected' : '' }}>فعّال</option>
                <option value="0" {{ old('validity', $service->validity ?? 1) == 0 ? 'selected' : '' }}>غير فعّال</option>
              </select>
              @error('validity')
              <div class="error-text">{{ $message }}</div>
              @enderror
