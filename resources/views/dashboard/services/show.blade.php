...
<div class="classify-show" dir="rtl">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          عرض الخدمة #{{ $service->srevicetyptid }}
        </li>
  ...
  <div class="main-card">
    ...
    <div class="form-header">
      ...
      <div>
        <h4>تفاصيل الخدمة #{{ $service->srevicetyptid }}</h4>
        <p>بيانات شاملة للخدمة المحددة</p>
      </div>
    </div>
    ...
    <div class="card-body p-lg-4 p-3">
      ...
      <div class="action-buttons">
        ...
        <a href="{{ route('services.index') }}" class="btn btn-secondary btn-custom">
      ...
      <div class="detail-card">
        ...
        <div class="detail-row">
          ...
          <div class="detail-item">
            ...
            <span class="detail-value">{{ $service->srevicetyptname ?? '-' }}</span>
          </div>

          <div class="detail-item">
            <span class="detail-label">الحالة</span>
            <span class="status-badge {{ $service->validity == 1 ? 'active' : 'inactive' }}">
              {{ $service->validity == 1 ? 'فعّال' : 'غير فعّال' }}
            </span>
          </div>
      ...
      <div class="detail-card">
        ...
        <div class="detail-row">
          ...
          <div class="detail-item">
            ...
            <span class="detail-value">{{ $service->createdBy->userID ?? '-' }}</span>
          </div>
          ...
          <div class="detail-item">
            ...
            <span class="detail-value">{{ $service->updatedBy->userID ?? '-' }}</span>
          </div>
