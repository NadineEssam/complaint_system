...
<section class="section">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('complaints.responses.store') }}">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" name="ComplaintStatus" id="statusSelect">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="ComplaintText"></textarea>
                    </div>
                </div>
                ...
                <!-- تصنيف السبب -->
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">تفاصيل سبب الشكوى</label>
                    <div class="col-sm-10">
